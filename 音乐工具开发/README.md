...
1. **生物物理调式映射（推荐）**：以音乐可听性为优先，符号与连续理化特征分别进入调式、节奏、力度、奏法、CC 和空间。可选大调、自然/和声/旋律小调、七种教会调式、五声、布鲁斯、全音、八音和半音体系。
...
测试覆盖 FASTA 完整导出、扩展调式、多轨/多 Part 编配、蛋白质连续 CC、JSON/MusicXML/MIDI 符号载荷恢复、可选康托往返与越界拒绝、PDB 空间/NMA 和 CSV QC 滤波。
